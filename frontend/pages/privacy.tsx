export default () => (
    <>
        ...
        <li>
        <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Paname</p>
        </li>
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to paname.io, 15 Rue des Halles, 75001 Paris - Anthony de Symbiose SAS.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to paname.io, accessible from <a href="https://paname.io" rel="external nofollow noopener" target="_blank">https://paname.io</a></p>
        </li>
        <li>
        ...
        <h2>Protecting Your Credit Card Information</h2>
        <p>The credit card information provided by you to Us will be stored in a confidential manner and immediately deleted once the Service has been provided. Our employees may access such information only when there is an appropriate business reason to do so, such as support. We maintain physical, electronic and procedural safeguards to protect your information, and our employees are required to follow these privacy standards.</p>
        <h2>Payment Retention of Your Data</h2>
        <p>When you sign up for a paid subscription with Us, we will also collect, as necessary, your billing information and billing address (collectively, “Billing Information”) to complete your order for the purchase of the Services via our Site. We use Stripe to process payments through our Site. We do not directly collect or store any payment card information entered through our Services, but we may receive information associated with your payment card information (e.g., your billing details). In connection with this service that Stripe provides to Us, Stripe may also collect your Billing Information. The information that you provide through Stripe is subject to the Stripe Privacy Policy (available at https://stripe.com/us/privacy/). You should read the Stripe Privacy Policy to learn about Stripe’s information collection and usage.</p>
        ...
        <ul>
        <li>By email: hello@paname.io</li>
        </ul>
    </>
);